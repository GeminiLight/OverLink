          ...
          <div className="flex min-h-[90vh] flex-col items-center justify-center p-8 z-10 animate-fade-in text-center max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-5 w-full max-w-lg">
              ...
              <button
                ...
                className="flex-1 py-5 bg-white dark:bg-slate-900 text-slate-900 dark:text-white border border-slate-200 dark:border-white/10 rounded-2xl font-bold shadow-xl hover:bg-slate-50 dark:hover:bg-slate-800 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 text-lg"
              >
